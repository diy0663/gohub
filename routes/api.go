...
func RegisterAPIRoutes(r *gin.Engine) {
	...
	v1 := r.Group("/v1")
	{
		...
		catgoryGroup := v1.Group("/categories")
		{
			catgoryGroup.POST("", middlewares.AuthJWT(), category_controller.Store)
			catgoryGroup.PUT("/:id", middlewares.AuthJWT(), category_controller.Update)
		}
