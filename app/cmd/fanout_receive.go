...
var CmdFanoutReceive = &cobra.Command{
	Use:   "fanout_receive",
	Short: "HERE PUTS THE COMMAND DESCRIPTION",
	Run:   runFanoutReceive,
	Args:  cobra.ExactArgs(0), // 只允许且必须传 1 个参数
}

func runFanoutReceive(cmd *cobra.Command, args []string) {

	console.Success("开始接收fanout 广播数据")
	r := rabbitmq.NewRabbitMQFanout("THE_FANOUT_EXCHANE")
	defer r.Destory()
	r.ConsumeFanout()
}
